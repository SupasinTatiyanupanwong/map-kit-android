...
class GoogleIndoorLevel implements IndoorLevel {
    ...
    private GoogleIndoorLevel(@NonNull com.google.android.gms.maps.model.IndoorLevel delegate) {
        mDelegate = delegate;
    }
    ...
    @Override public boolean equals(@Nullable Object obj) {
        ...
        GoogleIndoorLevel that = (GoogleIndoorLevel) obj;
    ...
    static List<IndoorLevel> wrap(List<com.google.android.gms.maps.model.IndoorLevel> delegates) {
        if (delegates == null) {
            return null;
        }
        ...
        for (int iter = 0, size = delegates.size(); iter < size; iter++) {
            list.add(new GoogleIndoorLevel(delegates.get(iter)));
        }
        return list;
    }
