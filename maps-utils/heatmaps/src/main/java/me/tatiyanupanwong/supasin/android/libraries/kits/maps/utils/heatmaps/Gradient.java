...
/**
 * A class to generate a color map from a given array of colors and the fractions that the colors
 * represent by interpolating between their HSV values.
 * <p>
 * This color map is to be used in the {@link HeatmapTileProvider}.
 */
