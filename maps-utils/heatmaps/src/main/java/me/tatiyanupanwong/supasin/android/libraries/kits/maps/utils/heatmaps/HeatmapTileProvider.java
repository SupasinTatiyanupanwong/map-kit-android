...
import me.tatiyanupanwong.supasin.android.libraries.kits.maps.utils.geometry.Bounds;
...
public class HeatmapTileProvider implements TileProvider {
     ...
     * Package access for {@link WeightedLatLng}.
     */
     ...
     * <p>
     * User should clear overlay's tile cache (using {@link TileOverlay#clearTileCache()}) after
     * calling this.
     *
     * @param data Data set of points to use in the heatmap, as {@link LatLng}s.
    ...
    /**
     * Helper function - wraps {@link LatLng}s into {@link WeightedLatLng}s.
     *
     * @param data Data to wrap ({@link LatLng})
     * @return Data, in {@link WeightedLatLng} form
     */
    ...
    private static Tile convertBitmap(Bitmap bitmap) {
        ...
        return MapKit.newTile(TILE_DIM, TILE_DIM, bitmapdata);
    }
     ...
     *
     * @param points Collection of {@link WeightedLatLng} to calculate bounds for
     * @return Bounds that enclose the listed {@link WeightedLatLng} points
     */
        ...
        for (x = 0; x < dimOld; x++) {
            for (y = 0; y < dimOld; y++) {
                ...
                if (val != 0) {
                    ...
                    // Replace Math.max
                    initial = Math.max(lowerLimit, x - radius);
        ...
        for (x = lowerLimit; x < upperLimit + 1; x++) {
            for (y = 0; y < dimOld; y++) {
                ...
                if (val != 0) {
                    ...
                    // replace math.max
                    initial = Math.max(lowerLimit, y - radius);
     ...
     *
     * @param points    Collection of {@link LatLng}s to put into buckets
    ...
    static double getMaxValue(Collection<WeightedLatLng> points, Bounds bounds, int radius,
        ...
        double boundsDim = Math.max(maxX - minX, maxY - minY);
    ...
    /**
     * Builder class for the {@link HeatmapTileProvider}.
     */
    public static class Builder {
        ...
        /**
         * Constructor for builder. No required parameters here, but user must call either
         * {@link #data(Collection)} or {@link #weightedData(Collection)}.
         */
        public Builder() {}

        /**
         * Setter for data in builder. Must call this or {@link #weightedData(Collection)}.
         *
         * @param val Collection of {@link LatLng}s to put into quadtree.
         *            Should be non-empty.
        ...
        /**
         * Setter for data in builder. Must call this or {@link #data(Collection)}.
         *
         * @param val Collection of {@link WeightedLatLng}s to put into quadtree.
         *            Should be non-empty.
         * @return updated builder object
         */
         ...
         *
         * @return {@link HeatmapTileProvider} created with desired options.
         */
