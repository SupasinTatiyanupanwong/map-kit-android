...
/**
 * An abstraction that shares the common properties of {@link KmlPlacemark} and
 * {@link GeoJsonFeature}.
 */
public class Feature extends Observable {
     ...
     * @return {@code true} if property key exists, {@code false} otherwise
     */
     ...
     *
     * @return {@code true} if there are properties in the properties map, {@code false} otherwise
     */
     ...
     *
     * @return {@code true} if feature contains geometry object, {@code false} otherwise
     */
     ...
     * @return previous value with the same key, otherwise {@code null} if the key didn't exist
     */
     ...
     * @return value of the removed property or {@code null} if there was no corresponding key
     */
