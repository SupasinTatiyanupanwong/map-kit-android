...
public class GeoJsonLayer extends Layer {
    ...
    public GeoJsonLayer(
        ...
        GeoJsonRenderer mRenderer = new GeoJsonRenderer(map, geoJsonFeatures, markerManager,
    ...
    public GeoJsonLayer(
            ...
            PolygonManager polygonManager,
            PolylineManager polylineManager,
            GroundOverlayManager groundOverlayManager) throws IOException, JSONException {
     ...
     * @param geoJsonFile GeoJSON data to add to the layer
     */
    public GeoJsonLayer(MapClient map, JSONObject geoJsonFile) {
     ...
     * @throws JSONException if the JSON file has invalid syntax and cannot be parsed successfully
     */
    public GeoJsonLayer(MapClient map, int resourceId, Context context) throws IOException, JSONException {
        this(map, createJsonFileObject(
                context.getResources().openRawResource(resourceId)), null, null, null, null);
    }
