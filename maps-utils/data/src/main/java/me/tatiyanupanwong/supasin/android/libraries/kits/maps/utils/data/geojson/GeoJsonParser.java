...
public class GeoJsonParser {
    ...
    private static LatLngBounds parseBoundingBox(JSONArray coordinates) throws JSONException {
        ...
        LatLng southWestCorner =
                MapKit.newLatLng(coordinates.getDouble(1), coordinates.getDouble(0));
        // Highest value for all axes
        LatLng northEastCorner =
                MapKit.newLatLng(coordinates.getDouble(3), coordinates.getDouble(2));
        return MapKit.newLatLngBounds(southWestCorner, northEastCorner);
    }
    ...
    private static LatLngAlt parseCoordinate(JSONArray coordinates) throws JSONException {
        ...
        LatLng latLng = MapKit
                .newLatLng(coordinates.getDouble(1), coordinates.getDouble(0));
