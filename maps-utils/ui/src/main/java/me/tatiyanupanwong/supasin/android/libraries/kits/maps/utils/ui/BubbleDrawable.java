...
package me.tatiyanupanwong.supasin.android.libraries.kits.maps.utils.ui;
...
class BubbleDrawable extends Drawable {
    ...
    public BubbleDrawable(Context context) {
        mMask = ContextCompat.getDrawable(context, R.drawable.mku_bubble_mask);
        mShadow = ContextCompat.getDrawable(context, R.drawable.mku_bubble_shadow);
    }
