...
public class IconGenerator {
    ...
    public IconGenerator(Context context) {
        ...
        mContainer = LayoutInflater.from(mContext).inflate(R.layout.mku_text_bubble, null);
        mRotationLayout = (RotationLayout) ((ViewGroup) mContainer).getChildAt(0);
        mContentView = mTextView = mRotationLayout.findViewById(R.id.mku_text);
     ...
     * #setTextAppearance} and {@link #makeIcon(CharSequence)} will operate upon that {@link
     * TextView}.
     */
    public void setContentView(View contentView) {
        ...
        final View view = mRotationLayout.findViewById(R.id.mku_text);
    ...
    private static int getTextStyle(int style) {
        switch (style) {
            ...
            case STYLE_DEFAULT:
            case STYLE_WHITE:
                return R.style.mku_Bubble_TextAppearance_Dark;
            case STYLE_RED:
            case STYLE_BLUE:
            case STYLE_GREEN:
            case STYLE_PURPLE:
            case STYLE_ORANGE:
                return R.style.mku_Bubble_TextAppearance_Light;
        }
    }
