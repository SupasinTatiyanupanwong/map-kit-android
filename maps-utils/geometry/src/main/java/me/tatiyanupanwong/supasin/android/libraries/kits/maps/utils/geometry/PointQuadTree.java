...
package me.tatiyanupanwong.supasin.android.libraries.kits.maps.utils.geometry;
 ...
 *
 * @see <a href="http://en.wikipedia.org/wiki/Quadtree">Quadtree</a> for details on the data
 * structure.
 */
public class PointQuadTree<T extends PointQuadTree.Item> {
    ...
    private void split() {
        ...
        mChildren.add(new PointQuadTree<T>(
                mBounds.minX, mBounds.midX, mBounds.minY, mBounds.midY, mDepth + 1));
        mChildren.add(new PointQuadTree<T>(
                mBounds.midX, mBounds.maxX, mBounds.minY, mBounds.midY, mDepth + 1));
        mChildren.add(new PointQuadTree<T>(
                mBounds.minX, mBounds.midX, mBounds.midY, mBounds.maxY, mDepth + 1));
        mChildren.add(new PointQuadTree<T>(
                mBounds.midX, mBounds.maxX, mBounds.midY, mBounds.maxY, mDepth + 1));
