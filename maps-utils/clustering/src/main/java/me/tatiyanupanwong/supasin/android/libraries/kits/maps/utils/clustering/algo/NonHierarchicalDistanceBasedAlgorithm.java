 ...
 */
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> extends
        AbstractAlgorithm<T> {
    ...
    protected static class QuadItem<T extends ClusterItem> implements
        ...
        private QuadItem(T item) {
            ...
            mSingletonSet = Collections.singleton(mClusterItem);
        }
