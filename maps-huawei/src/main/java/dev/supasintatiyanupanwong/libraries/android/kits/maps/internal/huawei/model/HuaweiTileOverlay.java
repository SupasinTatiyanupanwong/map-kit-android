...
public class HuaweiTileOverlay implements TileOverlay {
    ...
    private HuaweiTileOverlay(com.huawei.hms.maps.model.TileOverlay delegate) {
        mDelegate = delegate;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        HuaweiTileOverlay that = (HuaweiTileOverlay) obj;
    ...
    static TileOverlay wrap(com.huawei.hms.maps.model.TileOverlay delegate) {
        return new HuaweiTileOverlay(delegate);
    }
    ...
    public static class Options implements TileOverlay.Options {
        ...
        static com.huawei.hms.maps.model.TileOverlayOptions unwrap(
                TileOverlay.Options wrapped) {
            return ((HuaweiTileOverlay.Options) wrapped).mDelegate;
        }
    }
